  ...
  return (
    <div className="min-h-screen bg-black text-white font-['IBM_Plex_Sans','Inter','system-ui']">
      ...
      <div className="fixed inset-0 pointer-events-none opacity-[0.03]" style={{
        backgroundImage:
          'repeating-linear-gradient(0deg, rgba(255,255,255,0.8) 0, rgba(255,255,255,0.8) 1px, transparent 2px, transparent 4px)'
      }} />
      ...
      <footer id="contact" className="relative border-t border-white/10 bg-[#06000a]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-white/70 text-sm">© {new Date().getFullYear()} RetroCRT — Crafted with neon and care.</p>
